...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        add_user('michael', 'email@michael@realpython.com')
        with self.client:
    ...
    def test_single_user(self):
        ...
        with self.client:
            ...
            self.assertIn('michael', users_data[0]['username'])
            self.assertIn('michael@realpython.com', users_data[0]['email'])
            self.assertIn('fletcher', users_data[1]['username'])
            self.assertIn('fletcher@realpython.com', users_data[1]['email'])
            self.assertIn('success', data['status'])
